/*! art-template@4.10.1 for browser | https://github.com/aui/art-template */ ! function(e, t) {
	...
	return function(e) {
					...
					try {
						...
						for(var $ = 0, j = 0, S = 0; $ < n.length;) {
							...
							if(!this.checkExpression(_.code)) {
								j = _.tplToken.line, S = _.tplToken.start;
								break
							}
							$++
						}
		...
		var a = function(e) {
			function t(n) {
				...
				return i.name = "TemplateError", i.message = s(n), Error.captureStackTrace && Error.captureStackTrace(i, i.constructor), i
			}
			return i(t, e), t
		}(Error);
		e.exports = a
				...
				for(var t = e.test.ignoreCase ? "ig" : "g", o = e.test.source + "|^$|[\\w\\W]", i = new RegExp(o, t), s = 0; s < r.length; s++)
					if("string" === r[s].type) {
						for(var a = r[s].line, c = r[s].start, u = r[s].end, p = r[s].value.match(i), l = [], f = 0; f < p.length; f++) {
							...
							if("string" === d) v && "string" === v.type ? (v.value += h, v.end += h.length) : l.push(b);
							else {
